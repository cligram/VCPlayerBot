...
async def start(client, message):
    ...
    buttons = [
        [
            ...
            InlineKeyboardButton('🧩 درخواست نصب ربات', url='https://t.me/MissHesari')
        ],
        [
...
async def repo_(client, message):
    buttons = [
        [
            InlineKeyboardButton('🧩 سازنده ربات', url='https://t.me/MissHesari'),
            InlineKeyboardButton('⚙️ کانال ربات', url='https://t.me/OnlineMusic24'),     
        ],
        [
            InlineKeyboardButton("🎞 نحوه فعالسازی ربات", url='https://t.me/MissHesari'),
            InlineKeyboardButton('🗑 خروج', callback_data='close'),
        ]
    ]
    await message.reply("<b>برای اطلاع  بیشتر و نصب ربات پخش کننده موزیک و ویدیو در گروهتان با آیدی سازنده ربات در ارتباط باشید. <a href=https://t.me/MissHesari>OnlineMusic24.</a>\n هم ویدیو هم موزیک قابل پخش است.\n\nبدون محدویت حجم فایل 🙃.</b>", reply_markup=InlineKeyboardMarkup(buttons), disable_web_page_preview=True)
    await delete_messages([message])
        ...
        if " " in message.text:
            ...
            if "=" in env:
                ...
                if env_ in ENV_VARS:
                    ...
                    await m.edit("ورودی ارسالی نامعتبر است. از سازنده ربات (@MissHesari) درخواست کمک نمایید.")
